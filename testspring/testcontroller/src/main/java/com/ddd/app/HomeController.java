...
public class HomeController {
	...
	@RequestMapping(value ="/fileUploadAjaㄴㄴㄴx")
	@ResponseBody
	public String fileUploadAjax(MultipartHttpServletRequest  multipartRequest) throws IOException{
	...
	String path = "C:/Users/user/Downloads";  //제 바탕화면의 upload 폴더라는 경로입니다. 자신의 경로를 쓰세요.​
	...
	@ResponseBody
//	@CrossOrigin(origins = "*", allowedHeaders = "*")
	@RequestMapping(value = "/fileUploadAjax", method = RequestMethod.POST,headers = ("content-type=multipart/*"))
	public MultipartFile ttest(@RequestParam(value="img", required=false) MultipartFile file) {
		System.out.println("실행");
		System.out.println("이게 파일이름=>"+file.getOriginalFilename());
