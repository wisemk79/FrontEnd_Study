                            ...
                            <img className="header-position" src={logo} width="89px" alt="Logo" />
                                ...
                                <Nav.Link className="edge-menu" href="/join">회원가입</Nav.Link>
                                    <NavDropdown className="edge-menu" title="고객센터">
                                        <NavDropdown.Item className="edge-drop-item" href="/customer/notice">공지사항</NavDropdown.Item>
                                        <NavDropdown.Item className="edge-drop-item" href="/customer/temp">자주하는 질문</NavDropdown.Item>
                                        <NavDropdown.Item className="edge-drop-item" href="/customer/qna">1:1문의</NavDropdown.Item>
                                    </NavDropdown>
                                </Nav>
                        </Navbar>
                </Col>
